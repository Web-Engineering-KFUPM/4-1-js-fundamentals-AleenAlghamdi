...
const SCHOOL = "MyCollege";
// SCHOOL = "OtherCollege"; // Error: Assignment to constant variable (const variables cannot be reassigned)
...
// write code here
console.log("2" + 3); // "23" - string concatenation because one operand is string
console.log(2 + "3"); // "23" - string concatenation because one operand is string
